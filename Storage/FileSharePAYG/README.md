...
| replicationType | Standard_LRS | Storage account SKU replication type. Supported values include Standard_LRS, Standard_GRS, Standard_RAGRS, Standard_ZRS, Standard_GZRS, Standard_RAGZRS |
